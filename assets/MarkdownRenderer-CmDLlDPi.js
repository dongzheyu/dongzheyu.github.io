import{A as y,M as v,O as x,b as _,t as h,w}from"./vendor-DHU-KEtL.js";import{i as f}from"./index-C0X6KV32.js";var b=["innerHTML"],k=x({__name:"MarkdownRenderer",props:{content:{}},setup(i){const l=i,a=new h({html:!0,linkify:!0,typographer:!0,breaks:!0}),u=a.renderer.rules.fence||function(t,o,c,n,e){return e.renderToken(t,o,c)};a.renderer.rules.fence=(t,o,c,n,e)=>{const r=t[o];r.content;const d=r.info.trim(),s=`code-${Math.random().toString(36).substr(2,9)}`,m=u(t,o,c,n,e);return`
