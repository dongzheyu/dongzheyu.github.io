          ...
          <div class="space-y-8">
            <div class="relative pl-8 border-l-2 border-snip-orange/30">
              ...
              <div class="space-y-3">
                ...
                <h3 class="text-lg font-bold" data-i18n="cl127_title">${e.cl127_title}</h3>
                <ul class="space-y-2 text-snip-muted text-sm">
                  ${[1,2,3,4,5,6,7,8,9].map(t=>`<li class="flex items-start gap-2"><span class="text-snip-orange shrink-0">-</span><span data-i18n="cl127_l${t}">${e[`cl127_l${t}`]}</span></li>`).join("")}
                </ul>
              </div>
            </div>
            ${[["126",""],["125",""],["124","stable"],["122",""],["121",""],["11x","final"],["10",""]].map(([t,l])=>`
            <div class="relative pl-8 border-l-2 border-snip-gray-light">
              ...
              <div class="space-y-3">
                ...
                <ul class="space-y-2 text-snip-muted text-sm">
                  ${t==="127"?[1,2,3,4,5,6,7,8,9].map(s=>`<li class="flex items-start gap-2"><span class="text-snip-orange shrink-0">-</span><span data-i18n="cl127_l${s}">${e[`cl127_l${s}`]}</span></li>`).join(""):""}
