        ...
        <div class="row align-items-center">
          <div class="col-lg-8" style="padding-left: 5%">
            ...
            <p class="test-hero-desc">
              "阳光抑郁症"（Smiling
              Depression）又称微笑型抑郁，指一种表面上看起来开朗、积极、功能正常，
      ...
      <div v-if="showResult" class="result-section">
        ...
        <div class="score-card mb-5">
          <div class="score-visual" :style="`--score-color: ${result.color}`">
            ...
            <div class="score-bar-wrap">
              <div
                ...
                :style="`width: ${(totalScore / 60) * 100}%; background: ${result.color}`"
              ></div>
            </div>
          </div>
          <div class="score-info">
            <div
              class="score-badge"
              :style="`background: ${result.color}20; color: ${result.color}; border-color: ${result.color}40`"
            >
              {{ result.level }}
            </div>
        ...
        <div class="notice-box mb-5">
          ...
          <div>
            <strong>测试说明</strong>
            <p>
              本测试基于阳光抑郁症的研究特征设计，不是临床诊断工具。得分偏高并不意味着你患有抑郁症，但值得认真对待自己的内心感受。如果你长期感到内外不一致的痛苦，建议寻求专业心理咨询。
            </p>
          </div>
        </div>
...
.agree-btn.selected .agree-label {
