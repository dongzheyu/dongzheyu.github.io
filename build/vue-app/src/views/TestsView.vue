...
const tests = ref([
  {
    ...
    badge: 'MBTI',
    gradient: 'linear-gradient(135deg, rgba(27,217,106,0.15) 0%, rgba(15,170,79,0.08) 100%)',
    color: '#1bd96a',
    category: '人格',
    questions: 93,
    minutes: 15,
  ...
  },
  {
    ...
    icon: 'bi bi-sun',
    badge: '微笑抑郁',
    gradient: 'linear-gradient(135deg, rgba(27,217,106,0.15) 0%, rgba(66,230,134,0.08) 100%)',
    color: '#1bd96a',
    category: '情绪',
    questions: 15,
    minutes: 8,
  ...
  },
  {
    ...
    badge: 'ASRS',
    gradient: 'linear-gradient(135deg, rgba(66,230,134,0.15) 0%, rgba(27,217,106,0.08) 100%)',
    color: '#1bd96a',
    questions: 18,
    minutes: 5,
  },
