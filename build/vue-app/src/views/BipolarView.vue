        ...
        <div class="row align-items-center">
          <div class="col-lg-8" style="padding-left: 5%">
            ...
            <p class="test-hero-desc">
              心境障碍问卷（Mood Disorder Questionnaire）是由 Hirschfeld 等人于 2000
              年开发的筛查工具，用于识别可能与双相情感障碍相关的症状。
    ...
    <div class="container-fluid px-4 test-body">
      <div v-if="!showResult">
        <p class="freq-instruction mb-5" style="padding-left: 5%">
          以下清单描述了人们在情绪特别高昂、亢奋或激动时可能出现的情况。请回想你一生中是否有过类似体验（持续至少几天）：
        </p>
        <div
      ...
      <div v-if="showResult" class="result-section">
        ...
        <div class="important-notice mb-5">
          ...
          <div>
            ...
            <p>
              MDQ
              是筛查工具，不是诊断工具。双相情感障碍的诊断需要精神科医生通过详细的临床访谈和观察才能确定。如果你对这些症状感到担忧，请务必寻求专业评估。
            </p>
          </div>
        </div>
